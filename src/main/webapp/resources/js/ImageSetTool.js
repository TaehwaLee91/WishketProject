function AddStarImages(boxes){
  // star img 추가
  var full = '<img src="/resources/img/review-full-star.svg">';
  var empty = '<img src="/resources/img/review-empty-star.svg">';
...
function AddStarAvgImages(avg_score, $avg_img_box){
  ...
  var full = '<img src="/resources/img/review-full-star.svg">';
  var half = '<img src="/resources/img/review-half-star.svg">';
  var empty = '<img src="/resources/img/review-empty-star.svg">';
