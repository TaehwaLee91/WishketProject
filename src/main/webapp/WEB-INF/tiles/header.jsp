...
<header class="row">
    <nav class="nav navbar-expand navbar-dark bg-dark col-12" >
        <ul class="nav navbar-nav  nav-fill w-100  col-7   " style="margin:15px auto;">
            ...
            <li class="nav-item small font-weight-bold align-self-center"><a class="nav-link text-white" href="/guide/guide">이용방법</a></li>
            <li class="nav-item small font-weight-bold align-self-center"><a class="nav-link text-white" href="/guide/postscript">이용후기</a></li>
                ...
                <c:if test="${not empty UID}">
                    <div class="dropdown" >
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" id="myPage" href="/partners/p">내프로필</a>
