                    ...
                    <section class="search-list bg-white">
                        <section class="result-header-wrap" style="margin-top: -30px;">
                            <div class="result-header">
                                <div class="count-box">
                                    <br><br>
                                    <span class="body-1-medium count-title">31,083개의 프로젝트</span>
                                        ...
                                        <div class="project-unit-body">
                                            <section class="project-unit-info">
                                                ...
                                                <div class="project-info-tag">
                                                    ...
                                                    <div class="project-recruit-guide caption-1 text300" style="font-size: 13px; float: left; opacity: 0.5">등록 일자 2021.02.26
                                                    </div>
                                                </div>
                                            </section>
                                        </div>
